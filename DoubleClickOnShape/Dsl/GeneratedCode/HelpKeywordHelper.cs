...
namespace Company.DoubleClickOnShape
{
	...
	/// </remarks>
	public partial class DoubleClickOnShapeHelpKeywordHelper : DoubleClickOnShapeHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DoubleClickOnShapeHelpKeywordHelper.
		/// </summary>
		protected DoubleClickOnShapeHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DoubleClickOnShapeHelpKeywordHelper.
		/// </summary>
		public static DoubleClickOnShapeHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DoubleClickOnShapeHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DoubleClickOnShapeHelpKeywordHelperBase.
		/// </summary>
		protected DoubleClickOnShapeHelpKeywordHelperBase()
			: base() { }
