...
namespace Company.DoubleClickOnShape
{
	...
	public static partial class ExampleElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.DoubleClickOnShape.ExampleElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.DoubleClickOnShape.ExampleElement)
				{
					if (candidateTarget is global::Company.DoubleClickOnShape.ExampleElement)
					{
						global::Company.DoubleClickOnShape.ExampleElement sourceExampleElement = (global::Company.DoubleClickOnShape.ExampleElement)candidateSource;
						global::Company.DoubleClickOnShape.ExampleElement targetExampleElement = (global::Company.DoubleClickOnShape.ExampleElement)candidateTarget;
						if(targetExampleElement == null || sourceExampleElement == null || global::Company.DoubleClickOnShape.ExampleElementReferencesTargets.GetLinks(sourceExampleElement, targetExampleElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.DoubleClickOnShape.ExampleElement)
				{
					if (target is global::Company.DoubleClickOnShape.ExampleElement)
					{
						global::Company.DoubleClickOnShape.ExampleElement sourceAccepted = (global::Company.DoubleClickOnShape.ExampleElement)source;
						global::Company.DoubleClickOnShape.ExampleElement targetAccepted = (global::Company.DoubleClickOnShape.ExampleElement)target;
						DslModeling::ElementLink result = new global::Company.DoubleClickOnShape.ExampleElementReferencesTargets(sourceAccepted, targetAccepted);
