...
namespace Company.DoubleClickOnShape
{
	...
	/// </remarks>
	public partial class DoubleClickOnShapeToolboxHelper : DoubleClickOnShapeToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new DoubleClickOnShapeToolboxHelper.
		/// </summary>
		public DoubleClickOnShapeToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class DoubleClickOnShapeToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify DoubleClickOnShape toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "DoubleClickOnShape.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new DoubleClickOnShapeToolboxHelperBase.
		/// </summary>
		protected DoubleClickOnShapeToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel.SingletonResourceManager.GetString("DoubleClickOnShapeToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Company.DoubleClickOnShape.ExampleElementToolboxItem":
					// Add ExampleElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.DoubleClickOnShape.ExampleElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"Company.DoubleClickOnShape.DoubleClickOnShapeToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("DoubleClickOnShapeToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::Company.DoubleClickOnShape.ExampleElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "Company.DoubleClickOnShape.ExampleRelationshipToolboxItem":

					// Add ExampleRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Company.DoubleClickOnShape.ExampleRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel));
