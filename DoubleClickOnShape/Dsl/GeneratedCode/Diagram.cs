...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "Company.DoubleClickOnShape.DoubleClickOnShapeDiagram")]

namespace Company.DoubleClickOnShape
{
	/// <summary>
	/// DomainClass DoubleClickOnShapeDiagram
	/// Description for Company.DoubleClickOnShape.DoubleClickOnShapeDiagram
	/// </summary>
	[DslDesign::DisplayNameResource("Company.DoubleClickOnShape.DoubleClickOnShapeDiagram.DisplayName", typeof(global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel), "Company.DoubleClickOnShape.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("Company.DoubleClickOnShape.DoubleClickOnShapeDiagram.Description", typeof(global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel), "Company.DoubleClickOnShape.GeneratedCode.DomainModelResx")]
	[DslModeling::DomainModelOwner(typeof(global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel))]
	[global::System.CLSCompliant(true)]
	[DslModeling::DomainObjectId("95d0bd1f-416e-48e5-b55a-85b318d73a23")]
	public partial class DoubleClickOnShapeDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::Company.DoubleClickOnShape.DoubleClickOnShapeToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		{
			if(element is global::Company.DoubleClickOnShape.ExampleElement)
			{
				global::Company.DoubleClickOnShape.ExampleShape newShape = new global::Company.DoubleClickOnShape.ExampleShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::Company.DoubleClickOnShape.ExampleElementReferencesTargets)
			{
				global::Company.DoubleClickOnShape.ExampleConnector newShape = new global::Company.DoubleClickOnShape.ExampleConnector(this.Partition);
				return newShape;
			}
		...
		internal static partial class ExampleShapeDecoratorMap
		{
			...
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::Company.DoubleClickOnShape.ExampleElement.NameDomainPropertyId);
		...
		private global::Company.DoubleClickOnShape.ExampleRelationshipConnectAction exampleRelationshipConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::Company.DoubleClickOnShape.DoubleClickOnShapeToolboxHelper.ExampleRelationshipFilterString))
				{
					if (this.exampleRelationshipConnectAction == null)
					{
						this.exampleRelationshipConnectAction = new global::Company.DoubleClickOnShape.ExampleRelationshipConnectAction(this);
		...
		/// <summary>
		/// DoubleClickOnShapeDiagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0x95d0bd1f, 0x416e, 0x48e5, 0xb5, 0x5a, 0x85, 0xb3, 0x18, 0xd7, 0x3a, 0x23);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public DoubleClickOnShapeDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public DoubleClickOnShapeDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace Company.DoubleClickOnShape
{
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::Company.DoubleClickOnShape.ExampleElement), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::Company.DoubleClickOnShape.ExampleElementReferencesTargets), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				if(childElement is global::Company.DoubleClickOnShape.ExampleElement)
				{
					parentElement = GetParentForExampleElement((global::Company.DoubleClickOnShape.ExampleElement)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::Company.DoubleClickOnShape.ExampleModel GetParentForExampleElement( global::Company.DoubleClickOnShape.ExampleElement root )
			{
				// Segments 0 and 1
				global::Company.DoubleClickOnShape.ExampleModel result = root.ExampleModel;
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::Company.DoubleClickOnShape.DoubleClickOnShapeDiagram diagram = linkShape.Diagram as global::Company.DoubleClickOnShape.DoubleClickOnShapeDiagram;
						if (diagram != null)
						{
