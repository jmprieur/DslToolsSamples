...
namespace Company.DoubleClickOnShape
{
	...
	/// </summary>
	internal partial class DoubleClickOnShapeCommandSet : DoubleClickOnShapeCommandSetBase
	{
		/// <summary>
		/// Constructs a new DoubleClickOnShapeCommandSet.
		/// </summary>
		public DoubleClickOnShapeCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class DoubleClickOnShapeCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new DoubleClickOnShapeCommandSetBase.
		/// </summary>
		protected DoubleClickOnShapeCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewDoubleClickOnShapeExplorerCommand,
				typeof(DoubleClickOnShapeEditorFactory).GUID);
		...
		{
			DoubleClickOnShapeExplorerToolWindow explorer = this.DoubleClickOnShapeExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected DoubleClickOnShapeDocData CurrentDoubleClickOnShapeDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as DoubleClickOnShapeDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected DoubleClickOnShapeDocView CurrentDoubleClickOnShapeDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as DoubleClickOnShapeDocView;
			}
		}
		...
		/// </summary>
		protected DoubleClickOnShapeExplorerToolWindow DoubleClickOnShapeExplorerToolWindow
		{
			get
			{
				DoubleClickOnShapeExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(DoubleClickOnShapeExplorerToolWindow), true) as DoubleClickOnShapeExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				DoubleClickOnShapeExplorerToolWindow explorerWindow = this.DoubleClickOnShapeExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class DoubleClickOnShapeClipboardCommandSet : DoubleClickOnShapeClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new DoubleClickOnShapeClipboardCommandSet.
		/// </summary>
		public DoubleClickOnShapeClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class DoubleClickOnShapeClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new DoubleClickOnShapeClipboardCommandSetBase.
		/// </summary>
		protected DoubleClickOnShapeClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
