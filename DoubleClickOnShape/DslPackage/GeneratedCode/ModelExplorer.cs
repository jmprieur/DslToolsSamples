...
namespace Company.DoubleClickOnShape
{
	...
	/// </summary>
	internal partial class DoubleClickOnShapeExplorer : DoubleClickOnShapeExplorerBase
	{
		/// <summary>
		/// Constructs a new DoubleClickOnShapeExplorer.
		/// </summary>
		public DoubleClickOnShapeExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the DoubleClickOnShapeExplorerToolWindow.
	/// </summary>
	internal abstract class DoubleClickOnShapeExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new DoubleClickOnShapeExplorerBase.
		/// </summary>
		protected DoubleClickOnShapeExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.DoubleClickOnShapeExplorerMenu;
			}
		}
		...
		{
			get { return global::Company.DoubleClickOnShape.ExampleModel.DomainClassId; }
		}
