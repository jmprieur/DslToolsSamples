...
namespace Company.DoubleClickOnShape
{
	...
	/// </summary>
	internal partial class DoubleClickOnShapeDocData : DoubleClickOnShapeDocDataBase
	{
		/// <summary>
		/// Constructs a new DoubleClickOnShapeDocData.
		/// </summary>
		public DoubleClickOnShapeDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a DoubleClickOnShape document in memory.
	/// </summary>
	internal abstract partial class DoubleClickOnShapeDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new DoubleClickOnShapeDocDataBase.
		/// </summary>
		protected DoubleClickOnShapeDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Company.DoubleClickOnShape.ExampleModel modelRoot = null;
			...
			global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Company.DoubleClickOnShape.DoubleClickOnShapeSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Company.DoubleClickOnShape.ExampleModel modelRoot = (global::Company.DoubleClickOnShape.ExampleModel)this.RootElement;
			...
			{
				global::Company.DoubleClickOnShape.DoubleClickOnShapeDiagram diagram = diagrams[0] as global::Company.DoubleClickOnShape.DoubleClickOnShapeDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Company.DoubleClickOnShape.DoubleClickOnShapeSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Company.DoubleClickOnShape.DoubleClickOnShapeSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Company.DoubleClickOnShape.DoubleClickOnShapeDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Company.DoubleClickOnShape.DoubleClickOnShapeSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Company.DoubleClickOnShape.ExampleModel modelRoot = this.RootElement as global::Company.DoubleClickOnShape.ExampleModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Company.DoubleClickOnShape.DoubleClickOnShapeSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
