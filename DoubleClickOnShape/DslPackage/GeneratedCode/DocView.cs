...
namespace Company.DoubleClickOnShape
{
	...
	/// </summary>
	internal partial class DoubleClickOnShapeDocView : DoubleClickOnShapeDocViewBase
	{
		/// <summary>
		/// Constructs a new DoubleClickOnShapeDocView.
		/// </summary>
		public DoubleClickOnShapeDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DoubleClickOnShapeDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DoubleClickOnShapeDocView.
		/// </summary>
		protected DoubleClickOnShapeDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DoubleClickOnShapeDocDataBase docData = this.DocData as DoubleClickOnShapeDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DoubleClickOnShapeDocViewBase should be an DoubleClickOnShapeDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.DoubleClickOnShape.DoubleClickOnShapeDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.DoubleClickOnShape.DoubleClickOnShapeDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.DoubleClickOnShape.DoubleClickOnShapeToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.DoubleClickOnShape.DoubleClickOnShapeToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DoubleClickOnShapeDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.DoubleClickOnShape.DoubleClickOnShapeHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.DoubleClickOnShape.DoubleClickOnShapeHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.DoubleClickOnShape.DoubleClickOnShapeHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
